...
# add
curl -XPOST -H "Content-Type:application/json"  --url "localhost:3000/txh" -d '{"txid": "2", "network_id": "1", "from": "0x2", "to_network_id": "1", "to": "0x2", "type":0, "value": 1, "block_num": 1027, "name": "ERC20", "kind": "send"}'
